...
export class RequestsPage implements OnInit {
  ...
  ngOnInit() {
    ...
    let that = this;
    if(user ==="X"){
      let buyTs = [1593274988, 1593254988, 	1552364112, 1547547811, 1530138736]
      let sellTs = [1593273988, 1568867093, 1530128736]
        ...
        for (const data of datas) {
          ...
          if (cur > 60 && cur < 63) {
            if(cur === 61){
              ...
              data.Title_Deed.Mark[0].Mark_No = 208;
    ...
    let sellTs = [1579061170, 1568868093, 1530118736, 1530138836]
    let bTIndex =0, sTIndex=0;
    this.landInfoService.getJSON().subscribe((datas) => {
      let cur = 0;
      for (const data of datas) {
